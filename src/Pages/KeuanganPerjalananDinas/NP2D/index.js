    ...
    return (
        <main>
            <MainHeader>
                ...
                >
                    <div>
                        <h1 className="title">Keuangan - NP2D</h1>
                        {
            ...
            <div className="wrapper-content">
                ...
                <Table
                    listLabel={[
                        ...
                        {id: 'tgl_np2d', name: 'Tgl NP2D'},
                        {id: 'no_npd', name: 'No.NPD'},
                        {id: 'uraian', name: 'Uraian'},
                        {id: 'sub_kegiatan', name: 'Sub Kegitan'},
                        {id: 'kode_rek', name: 'Kode Rek'},
                        {id: 'jumlah', name: 'Jumlah'},
                        {id: 'aksi', name: 'Aksi'},
                    ]}
                >
                    <tr>
                        <TableContent>001-NP2D-2023</TableContent>
                        <TableContent>05-Jan-2023</TableContent>
                        <TableContent>001-KWT-2023</TableContent>
                        <TableContent>Dibayar belanja Perjalanan Dinas Biasa </TableContent>
                        <TableContent>05-Jan-2023</TableContent>
                        <TableContent>05-Jan-2023</TableContent>
                        <TableContent>430.000</TableContent>
